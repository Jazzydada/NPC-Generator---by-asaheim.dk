...
const SPEECH_DA = ["Dyb og rumlende",
  ...
  "Skiftende tonehøjde",];
const PITCH_EN = [   "Always whispering",
    "Constantly shouting",
    "Speaks in riddles",
    "Misuses proverbs at odd times",
    "Stutters",
    "Overlong vowels (‘I thiiiink…’)",
    "Clips off words",
    "Talks very quickly",
    "Talks painfully slowly",
    "Speaks in rhyme",
    "Talks in third person",
    "Calls everyone ‘my friend’",
    "Shrill, hysterical laugh",
    "Tears up mid-sentence",
    "Nervous giggle",
    "Slips into another language",
    "Heavy foreign accent",
    "Echoes others’ last words",
    "Wildly mixed metaphors",
    "Interrupts self with curses",
    "Animal noises between words",
    "Starts every sentence with ‘Well…’",
    "Constant interrupter",
    "Says ‘uh’ every other word",
    "Uses fancy words wrong",
    "Obsessed with old sayings",
    "Sounds constantly drunk",
    "Sounds constantly angry",
    "Sounds constantly cheerful",
    "Sounds like they’re crying",
    "Sings instead of speaking",
    "Excessively polite in all cases",
    "Blunt and rude",
    "Short, choppy sentences",
    "Speaks without stopping to breathe",
    "Whisper then sudden shout",
    "Over-articulated diction",
    "Stage-actor projection",
    "Imitates others frequently",
    "Overloads with detail",
    "Speaks in half-sentences",
    "Never finishes sentences",
    "Begins with a quick prayer",
    "Mixes in animal growls",
    "Persistent cough mid-word",
    "Swears far too much",
    "Talks only about themself",
    "Feigns wisdom with long words",
    "Describes everything in past tense",
    "Predicts in future tense",
    "Adds comic book sound effects",
    "Asks ‘do you understand?’ often",
    "Gives everyone nicknames",
    "Whispering chuckle",
    "Barking loud laugh",
    "Speaks in meter/verse",
    "Pounds table for emphasis",
    "Exaggerated… dramatic… pauses",
    "Talks to their hat/pet/object",
    "Repeats ‘as I said’ constantly",
    "Marketplace hawker tone",
    "Oceanic metaphors for everything",
    "Religious phrases regardless of topic",
    "Barks soldier commands",
    "Barely audible mumble",
    "Always out of breath",
    "Starts with ‘listen here…’",
    "Starts with ‘by the gods…’",
    "Says own name often",
    "Repeats last word of each sentence",
    "Huge hand gestures at all times",
    "Carnival barker flourish",
    "Perpetual sighing tone",
    "Relentlessly encouraging tone",
    "Snide schoolmaster tone",
    "Threatening whisper",
    "Roaring laugh after each line",
    "Speaks only in exclamations",
    "Speaks only in questions",
    "Says ‘maybe’ every sentence",
    "Says ‘of course’ every sentence",
    "Says ‘why not?’ every sentence",
    "Voice just stops abruptly",
    "Sounds like a hymn",
    "Recites like a recipe",
    "Reads as if from a book",
    "Theatrical wails (‘oh, woe!’)",
    "Adds little whistles between words",
    "Clicks tongue before speaking",
    "Hums a note between phrases",
    "Ends statements with ‘right?’",
    "Overuses sports metaphors",
    "Chronically mispronounces names",
    "Whispers numbers as they talk",
    "Laughs at their own jokes",
    "Never uses contractions",
    "Ends every line with a proverb",
    "Overexplains mundane details"
];
const PITCH_DA = [   "Altid hviskende",
    "Råber konstant",
    "Taler i gåder",
    "Bruger ordsprog forkert på mærkelige tidspunkter",
    "Stammer",
    "Overlange vokaler (‘Jeeeg tææænker…’)",
    "Afklipper ord",
    "Taler meget hurtigt",
    "Taler pinligt langsomt",
    "Taler i rim",
    "Taler i tredje person",
    "Kald­er alle ‘min ven’",
    "Skinger, hysterisk latter",
    "Begynder at græde midt i en sætning",
    "Nervøst fnis",
    "Glider over i et andet sprog",
    "Tung udenlandsk accent",
    "Gentager andres sidste ord",
    "Blander vilde metaforer",
    "Afbryder sig selv med bandeord",
    "Dyrelyde mellem ord",
    "Begynder hver sætning med ‘Nå…’",
    "Konstant afbryder",
    "Siger ‘øh’ for hvert andet ord",
    "Bruger fine ord forkert",
    "Besat af gamle ordsprog",
    "Lyder konstant fuld",
    "Lyder konstant vred",
    "Lyder konstant munter",
    "Lyder som om de græder",
    "Synger i stedet for at tale",
    "Overdrevent høflig i alle situationer",
    "Brutal og uhøflig",
    "Korte, hakkede sætninger",
    "Taler uden at trække vejret",
    "Hvisker og råber pludseligt",
    "Overartikuleret diktion",
    "Teateragtig projektion",
    "Efterligner andre ofte",
    "Overdynger med detaljer",
    "Taler i halve sætninger",
    "Gør aldrig sætninger færdige",
    "Begynder med en hurtig bøn",
    "Blander dyrebrøl ind",
    "Vedvarende hoste midt i ord",
    "Bander alt for meget",
    "Taler kun om sig selv",
    "Foregiver visdom med lange ord",
    "Beskriver alt i datid",
    "Forudsiger i fremtid",
    "Tilføjer tegneserie-lydeffekter",
    "Spørger ofte ‘forstår du?’",
    "Giver alle øgenavne",
    "Hviskende fnisen",
    "Gøende høj latter",
    "Taler i versefødder",
    "Slår i bordet for at understrege",
    "Overdrevne… dramatiske… pauser",
    "Taler til sin hat/kæledyr/genstand",
    "Gentager ‘som jeg sagde’ konstant",
    "Markedsråber-tone",
    "Oceaniske metaforer for alt",
    "Religiøse vendinger uanset emne",
    "Kommanderer som en soldat",
    "Næsten uhørlig mumlen",
    "Altid forpustet",
    "Begynder med ‘lyt her…’",
    "Begynder med ‘ved guderne…’",
    "Siger sit eget navn ofte",
    "Gentager sidste ord i hver sætning",
    "Kæmpe håndbevægelser hele tiden",
    "Markedsplads-barker-stil",
    "Evigt sukkende tone",
    "Uophørligt opmuntrende tone",
    "Spydig skolelærerstemme",
    "Truende hvisken",
    "Brølende latter efter hver replik",
    "Taler kun i udråb",
    "Taler kun i spørgsmål",
    "Siger ‘måske’ i hver sætning",
    "Siger ‘selvfølgelig’ i hver sætning",
    "Siger ‘hvorfor ikke?’ i hver sætning",
    "Stemme stopper brat",
    "Lyder som en salme",
    "Oplæser som en opskrift",
    "Læser som fra en bog",
    "Teatralske klageråb (‘åh, ve!’)",
    "Tilføjer små fløjten mellem ord",
    "Klikker med tungen før de taler",
    "Nynner en tone mellem fraser",
    "Afslutter udsagn med ‘ikke sandt?’",
    "Overforbruger sportsmetaforer",
    "Forvansker konsekvent navne",
    "Hvisker tal mens de taler",
    "Griner af egne vittigheder",
    "Bruger aldrig sammentrækninger",
    "Slutter hver replik med et ordsprog",
    "Overforklarer trivielle detaljer"];
