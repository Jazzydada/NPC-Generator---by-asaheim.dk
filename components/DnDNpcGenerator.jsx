...
const PITCH_EN = ["Always whispering","Constantly shouting","Speaks in riddles","Misuses proverbs at odd times","Stutters","Overlong vowels (‘I thiiiink…’)","Hoarse voice","Nasal tone","Clips off words","Talks very quickly",
  ...
  "Sounds constantly drunk","Sounds constantly angry","Sounds constantly cheerful","Sounds like they’re crying","Sings instead of speaking","Excessively polite in all cases","Blunt and rude","Short, choppy sentences","Speaks without stopping to breathe","High, squeaky voice",
  "Deep rumbling voice","Pitch swings unpredictably","Metallic, tinny voice","Whisper then sudden shout","Over-articulated diction","Stage-actor projection","Imitates others frequently","Overloads with detail","Speaks in half-sentences","Never finishes sentences",
  "Begins with a quick prayer","Mixes in animal growls","Voice cracks suddenly","Persistent cough mid-word","Swears far too much","Talks only about themself","Feigns wisdom with long words","Describes everything in past tense","Predicts in future tense","Adds comic book sound effects",
  "Asks ‘do you understand?’ often","Gives everyone nicknames","Whispering chuckle","Barking loud laugh","Speaks in meter/verse","Pounds table for emphasis","Exaggerated… dramatic… pauses","Talks to their hat/pet/object","Repeats ‘as I said’ constantly","Marketplace hawker tone",
  "Oceanic metaphors for everything","Religious phrases regardless of topic","Barks soldier commands","Voice that grates the ear","Barely audible mumble","Noticeable tremble in voice","Always out of breath","Starts with ‘listen here…’","Starts with ‘by the gods…’","Says own name often",
  "Repeats last word of each sentence","Huge hand gestures at all times","Carnival barker flourish","Perpetual sighing tone","Relentlessly encouraging tone","Snide schoolmaster tone","Threatening whisper","Roaring laugh after each line","Speaks only in exclamations","Speaks only in questions",
  "Says ‘maybe’ every sentence","Says ‘of course’ every sentence","Says ‘why not?’ every sentence","Voice changes with mood","Voice just stops abruptly","Sounds like a hymn","Recites like a recipe","Reads as if from a book","Theatrical wails (‘oh, woe!’)","Adds little whistles between words",
  "Clicks tongue before speaking","Hums a note between phrases","Ends statements with ‘right?’","Overuses sports metaphors","Chronically mispronounces names","Whispers numbers as they talk","Laughs at their own jokes","Never uses contractions","Ends every line with a proverb","Overexplains mundane details"
];
const PITCH_DA = ["Hvisker altid","Råber konstant","Taler i gåder","Bruger ordsprog forkert på skæve tidspunkter","Stammer","Trækker voldsomt i vokalerne (‘Jeeeg synes…’)","Hæs stemme","Nasal klang","Hakker ordene af","Taler meget hurtigt",
  "Taler pinefuldt langsomt","Rimer når de taler","Taler i tredje person","Kalder alle ‘min ven’","Skinger, hysterisk latter","Begynder at græde midt i en sætning","Nervøs fnisen","Syngende dialekt","Glider over i et andet sprog","Tung udenlandsk accent",
  "Gentager andres sidste ord","Vildt blandede metaforer","Afbryder sig selv med eder","Fuldstændig monoton","Dyrelyde mellem ordene","Starter hver sætning med ‘Tja…’","Afbryder hele tiden","Siger ‘øh’ hvert andet ord","Bruger fine ord forkert","Besat af gamle talemåder",
  "Lyder konstant beruset","Lyder konstant vred","Lyder konstant munter","Lyder som om de græder","Synger i stedet for at tale","Overdrevent høflig i alle situationer","Brutal og uhøflig","Korte, hakkende sætninger","Taler uden at trække vejret","Skinger, pibende stemme",
  "Dyb, rumlende stemme","Tonehøjde svinger uforudsigeligt","Metallisk, blik-agtig stemme","Hvisker og råber pludseligt","Overartikuleret diktion","Teaterskuespiller-projektion","Efterligner andre ofte","Overdænger med detaljer","Taler i halve sætninger","Gør aldrig sætninger færdige",
  "Begynder med en hurtig bøn","Blender dyreknurren ind","Stemmen knækker pludseligt","Vedvarende hoste midt i ord","Bander alt for meget","Taler kun om sig selv","Foregiver visdom med lange ord","Beskriver alt i datid","Forudsiger alt i fremtid","Tilføjer tegneserie-lydord",
  "Spørger ‘forstår du?’ hele tiden","Giver alle øgenavne","Hviskende fnis","Bjæffende høj latter","Taler i takt/meter","Slår i bordet for at understrege","Overdrevne… dramatiske… pauser","Taler til sin hat/sit kæledyr/en genstand","Gentager ‘som jeg sagde’ hele tiden","Markedsråber-stemme",
  "Havmetaforer om alt","Religiøse fraser uanset emne","Gør kommandoer som en soldat","Stemme der skærer i øret","Næsten uhørlig mumlen","Tydelig rysten på stemmen","Altid forpustet","Starter med ‘hør her…’","Starter med ‘ved guderne…’","Siger sit eget navn ofte",
  "Gentager sidste ord i hver sætning","Voldsomme håndbevægelser hele tiden","Gøgler-agtig salgstale","Evigt suk-klingende tone","Utrætteligt opmuntrende tone","Spydig skolelærer-klang","Truende hvisken","Brølende latter efter hver replik","Taler kun i udråb","Taler kun i spørgsmål",
  "Siger ‘måske’ i hver sætning","Siger ‘selvfølgelig’ i hver sætning","Siger ‘hvorfor ikke?’ i hver sætning","Stemmen skifter med humøret","Stemmen stopper brat","Lyder som en salme","Remser op som en opskrift","Læser op som fra en bog","Teatralske jamren (‘åh, ve!’)","Tilføjer små fløjten mellem ord",
  "Klikker med tungen før hun/han taler","Summer en tone mellem fraser","Slutter sætninger med ‘ikke?’","Overbruger sportsmetaforer","Forvrænger navne kronisk","Hvisker tal mens de taler","Griner af egne vittigheder","Bruger aldrig sammentrækninger","Slutter hver linje med et ordsprog","Overforklarer banaliteter"];
